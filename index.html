...
<head>
  ...
  <link rel="shortcut icon" href="https://cdn.rawgit.com/jgthms/bulma/master/docs/favicons/favicon-32x32.png"
    type="image/x-icon" />
  ...
  <section class="hero is-info is-bold">
    <div class="hero-body">
      <div class="container has-text-centered">
        <h1 class="title">Free Bulma Templates</h1>
        <h2 class="subtitle">
        ...
        <a class="github-button" href="https://github.com/BulmaTemplates/bulma-templates" data-icon="octicon-star"
          data-size="large" data-show-count="true" aria-label="Star BulmaTemplates/bulma-templates on GitHub">Star</a>
    ...
    <div class="columns is-multiline">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          <header class="card-header">
            <p class="card-header-title">
              ...
              <span class="is-pulled-right">
                <a href="https://github.com/jgthms/bulma/releases/tag/0.9.4">
                  <span class="tag is-default is-primary" title="Current Version">v0.9.4</span>
                </a>
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/admin.html"><img src="images/admin.png" alt="Admin template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/admin.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/band.html"><img src="images/band.png" alt="Band template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/band.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/blog.html"><img src="images/blog.png" alt="Blog template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/blog.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
        ...
        <div class="card">
          <header class="card-header">
            <p class="card-header-title">
              ...
              <span class="is-pulled-right">
                <a href="https://github.com/jgthms/bulma/releases/tag/0.9.4">
                  <span class="tag is-default is-primary" title="Current Version">
                    v0.9.4
                  </span>
                </a>
                <span class="tag is-default is-info">
                  <i class="fas fa-desktop" title="Desktop Support"></i>
                </span>
              </span>
            </p>
          </header>
          <div class="card-content">
            <figure class="image">
              <a href="templates/cards.html"><img src="images/cards.png" alt="Cards template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/cheatsheet.html"><img src="images/cheatsheet.png"
                  alt="Cheatsheet template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/cheatsheet.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/cover.html"><img src="images/cover.png" alt="Cover template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/cover.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/documentation.html"><img src="images/documentation.jpg"
                  alt="Documentation template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/documentation.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
            <a href="https://github.com/BulmaTemplates/bulma-templates/blob/master/templates/documentation.html"
              class="card-footer-item"><i class="fas fa-code"></i>Source Code</a>
          </footer>
        </div>
      </div>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/forum.html"><img src="images/forum.png" alt="Hero template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/forum.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/hello-parallax.html"><img src="images/hello-parallax.png"
                  alt="Hello Parallax template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/hello-parallax.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/ghost-blog.html"><img src="images/ghost-blog.png"
                  alt="Ghost Blog template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/ghost-blog.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/hero.html"><img src="images/hero.png" alt="Hero template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/inbox.html"><img src="images/inbox.png" alt="Inbox template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/instaAlbum.html"><img src="images/instaalbum.png"
                  alt="Landing template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/instaAlbum.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/kanban.html"><img src="images/kanban.png" alt="Kanban template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/kanban[search].html"><img src="images/kanban2.png"
                  alt="Kanban template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/kanban[search].html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/landing.html"><img src="images/landing.png" alt="Landing template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/login.html"><img src="images/login.png" alt="Login template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/modal-cards.html"><img src="images/modalcards.png"
                  alt="modal-cards template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/modal-cards.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/neumorphic-login.html"><img src="images/neumorphic-login.png"
                  alt="modal-cards template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/neumorphic-login.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/personal.html"><img src="images/personal.png"
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/showcase.html"><img src="images/showcase.png"
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/register.html"><img src="images/register.png" alt="register template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/tabs.html"><img src="images/tabs.png" alt="tabs template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/contact.html"><img src="images/contact.png" alt="tabs template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/absurd.html"><img src="images/absurd2.png" alt="tabs template screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/absurd.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
            ...
            <div class="column is-4-desktop is-3-widescreen is-half-tablet">
              <div class="card">
                ...
                <div class="card-content">
                  <figure class="image">
                    <a href="templates/app-page.html"><img src="images/app-page.png" alt="tabs template screenshot" /></a>
                  </figure>
                </div>
                <footer class="card-footer">
                  <a href="templates/app-page.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
                  <a href="https://github.com/BulmaTemplates/bulma-templates/blob/master/templates/app-page.html"
                    class="card-footer-item"><i class="fas fa-code"></i>Source Code</a>
                </footer>
              </div>
            </div>
      ...
      <div class="column is-4-desktop is-3-widescreen is-half-tablet">
        <div class="card">
          ...
          <div class="card-content">
            <figure class="image">
              <a href="templates/blogpost-tailsaw.html"><img src="https://loremflickr.com/320/240?random=1" alt=" screenshot" /></a>
            </figure>
          </div>
          <footer class="card-footer">
            <a href="templates/blogpost-tailsaw.html" class="card-footer-item"><i class="fas fa-search"></i>Preview</a>
            <a href="https://github.com/BulmaTemplates/bulma-templates/blob/master/templates/blogpost-tailsaw.html"
              class="card-footer-item"><i class="fas fa-code"></i>Source Code</a>
          </footer>
        </div>
      </div>
        ...
        <center>
          <div class="box">
            <p class="has-text-centered">
              More templates are waiting for you to make them! So, give it a
              go.
            </p>
          </div>
        </center>
    ...
    <div class="container">
      <div class="content has-text-centered">
        <p>
          ...
          <a href="https://github.com/dansup">Daniel Supernault</a> and many
          <a href="https://github.com/BulmaTemplates/bulma-templates/graphs/contributors">
          contributors</a>. The Source Code is licensed
